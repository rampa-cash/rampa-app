...
export const IcoMoon = createIconSetFromIcoMoon(icoMoonConfig, 'icomoon', icoMoonFont);
...
export default function Icon({
    ...
    const wrapperStyle: StyleProp<ViewStyle> = [
        ...
        shape === 'circle' ? { borderRadius: baseSize / 2, width: baseSize, height: baseSize } : { borderRadius: 8 },
        { padding: size * 0.2 },
        containerStyle,
    ...
    return (
        <View style={wrapperStyle}>
            ...
            />
            {label && <Text style={[styles.label, { color: finalLabelColor }]}>{label}</Text>}
        </View>
    );
}
