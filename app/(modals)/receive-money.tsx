...
export default function ReceiveMoneyScreen() {
    ...
    const [selectedCurrency, setSelectedCurrency] =
        useState<ReceiveCurrency>('USD');
    const [currencyModalVisible, setCurrencyModalVisible] = useState(false);
    const selectedCurrencyMeta = CURRENCY_OPTIONS.find(
                    ...
                    >
                        <View style={styles.currencyPickerContent}>
                            <View style={[styles.currencyBadge]}>
                                <Icon
                                    name={selectedCurrencyMeta?.icon!}
                                    size={44}
                                    color={'#3E73C4'}
                                />
                            </View>
                            <AppText variant={TextVariant.Body}>
                                {selectedCurrencyMeta?.description}
                            </AppText>
                        </View>
                        <MaterialIcons
                            ...
                            <View style={{ gap: 8 }}>
                                {CURRENCY_OPTIONS.map(option => (
                                    <ListCard
                                        ...
                                        showChevron={false}
                                        onPress={() =>
                                            handleSelectCurrency(option.id)
                                        }
                                        style={
