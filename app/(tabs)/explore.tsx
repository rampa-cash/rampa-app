            ...
            <Collapsible title="Inputs (variants)">
                <View style={styles.section}>
                    ...
                    <AppInput
                        ...
                        right={
                            <Icon name={IconName.Property1Delete} size={18} />
                        }
                    />
                    <AppInput
            ...
            <Collapsible title="ListCard">
                <View style={styles.section}>
                    <ListCard
                        ...
                        left={<Icon name={IconName.Property1Verify} />}
                    />
                    <ListCard
                        title="Soporte"
                        description="Centro de ayuda"
                        right={<Icon name={IconName.Property1Help} />}
                        showChevron={false}
                    />
                    <ListCard
                        title="Tema"
                        onPress={() => {}}
                        left={<Icon name={IconName.Property1Theme} />}
                    />
                </View>
            </Collapsible>
                        ...
                        <TransactionCard
                            ...
                            left={
                                <Icon
                                    name={
                                        tx.positive
                                            ? IconName.Property1ArrowReceive
                                            : IconName.Property1ArrowSend
                                    }
                                />
                            }
                        />
