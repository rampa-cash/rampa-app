...
export default function VerifyCodeScreen() {
  ...
  const derivedMethod = useMemo<ContactMethod | null>(() => {
    if (typeof method === 'string' && (method === 'email' || method === 'phone')) {
      return method;
    }
  ...
  return (
    ...
    >
      ...
      <View style={styles.body}>
        ...
        <AppText variant={TextVariant.Secondary} color="lessEmphasis" style={styles.subtitle}>
        ...
        <Pressable style={styles.resend} onPress={() => setDigits(Array(CODE_LENGTH).fill(''))}>
      ...
      <AppButton title="Next" onPress={handleNext} disabled={!isComplete} />
    </ScreenContainer>
  );
}
